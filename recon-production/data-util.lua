...
data_util.mod_name = "recon-production"
...
function data_util.find_and_replace_ingredients(replacements)
  for _,recipe in pairs(data.raw.recipe) do
    ...
    if recipe.normal and recipe.normal.ingredients then find_and_replace_ingredients_sub(recipe.normal.ingredients, replacements) end
    if recipe.expensive and recipe.expensive.ingredients then find_and_replace_ingredients_sub(recipe.expensive.ingredients, replacements) end
  end
end
